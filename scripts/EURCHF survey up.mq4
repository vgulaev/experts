...
int findminimum()
{
   ...
   //Print("assets: ", assets," average price: ", averageprice, " total lots: ", totallots, " minimum: ", calculateminimum(1.199));
   Print(n);
   
   assets = AccountBalance() + swapsum;
   //Print(n);
   for (pos=0;pos<n;pos++)
   {
      ...
      Print(OrderOpenPrice(), " == ", calculateminimum(1.199) +  assets, " total lots: ", totallots);
      //Print(OrderOpenPrice(), " == ", calculateminimum(1.199), " total lots: ", totallots);
   }   
