...
//----
   ...
   for (pos=0;pos<limit;pos++)
   {
      ...
      ee = priceoffuture(pos, "6E_CONT");
      eb = priceoffuture(pos, "6B_CONT");
      ej = priceoffuture(pos, "6J_CONT");
      ec = priceoffuture(pos, "6C_CONT");
      ek = priceoffuture(pos, "USDSEK");
      es = priceoffuture(pos, "6S_CONT");
      
      dx = priceoffuture(pos, "DX_CONT");
